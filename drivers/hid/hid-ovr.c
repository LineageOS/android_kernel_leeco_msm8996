...
//LincolnUSB: fuck
    ...
    ret = hid_hw_raw_request(dev, buf[0], buf, count, report_type, HID_REQ_SET_REPORT); 
out_free:
	kfree(buf);
out:
	return ret;
...
//LincolnUSB: fuck!!! cannot use gear code directly......
...
//	{ HID_USB_DEVICE(USB_VENDOR_ID_LETV, USB_DEVICE_ID_LECV_COOLPRO_1) },
	{ HID_DEVICE(HID_BUS_ANY, HID_GROUP_LETV, USB_VENDOR_ID_LETV, USB_DEVICE_ID_LECV_COOLPRO_1) },  //LincolnUSB
	{ }
};
