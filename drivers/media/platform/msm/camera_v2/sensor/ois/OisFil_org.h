...
/* 8bit */
OISINI__ const struct STFILREG	CsFilReg_20M[]	= {
		{ 0x0111,	0x00},		/*00,0111*/
		{ 0x0113,	0x00},		/*00,0113*/
		{ 0x0114,	0x00},		/*00,0114*/
		{ 0x0172,	0x00},		/*00,0172*/
...
/* 32bit */
OISINI__ const struct STFILRAM	CsFilRam_20M[]	= {
		...
		{ 0x1004,	0x38A8A540},		/*38A8A540,1004,LPF,0.6Hz,0dB,fs/1,invert=0*/
		{ 0x1005,	0x38A8A540},		/*38A8A540,1005,LPF,0.6Hz,0dB,fs/1,invert=0*/
		{ 0x1006,	0x3F7FF580},		/*3F7FF580,1006,LPF,0.6Hz,0dB,fs/1,invert=0*/
		{ 0x1007,	0x3F800000},		/*3F800000,1007,0dB,invert=0*/
		{ 0x1008,	0xBF800000},		/*BF800000,1008,0dB,invert=1*/
		{ 0x1009,	0x00000000},		/*00000000,1009,Cutoff,invert=0*/
		...
		{ 0x1012,	0x3F7FFD00},		/*3F7FFD00,1012,Free,fs/1,invert=0*/
		{ 0x1013,	0x3FC83380},		/*3FC83380,1013,HBF,50Hz,150Hz,4dB,fs/1,invert=0*/
		{ 0x1014,	0xBFC58900},		/*BFC58900,1014,HBF,50Hz,150Hz,4dB,fs/1,invert=0*/
		{ 0x1015,	0x3F75E8C0},		/*3F75E8C0,1015,HBF,50Hz,150Hz,4dB,fs/1,invert=0*/
		{ 0x1016,	0x3F06BD80},		/*3F06BD80,1016,LBF,0.2Hz,0.38Hz,0dB,fs/1,invert=0*/
		{ 0x1017,	0xBF06BA00},		/*BF06BA00,1017,LBF,0.2Hz,0.38Hz,0dB,fs/1,invert=0*/
		{ 0x1018,	0x3F7FFC80},		/*3F7FFC80,1018,LBF,0.2Hz,0.38Hz,0dB,fs/1,invert=0*/
		...
		{ 0x101E,	0x00000000},		/*00000000,101E,Cutoff,invert=0*/
		...
		{ 0x1046,	0x38A8A540},		/*38A8A540,1046,LPF,0.6Hz,0dB,fs/1,invert=0*/
		{ 0x1047,	0x38A8A540},		/*38A8A540,1047,LPF,0.6Hz,0dB,fs/1,invert=0*/
		{ 0x1048,	0x3F7FF580},		/*3F7FF580,1048,LPF,0.6Hz,0dB,fs/1,invert=0*/
		...
		{ 0x10B0,	0x3E0DE280},		/*3E0DE280,10B0,LPF,1200Hz,0dB,fs/1,invert=0*/
		{ 0x10B1,	0x3E0DE280},		/*3E0DE280,10B1,LPF,1200Hz,0dB,fs/1,invert=0*/
		{ 0x10B2,	0x3F390EC0},		/*3F390EC0,10B2,LPF,1200Hz,0dB,fs/1,invert=0*/
		...
		{ 0x10C0,	0x3FE304C0},		/*3FE304C0,10C0,HBF,60Hz,1000Hz,6dB,fs/1,invert=0*/
		{ 0x10C1,	0xBFDF6540},		/*BFDF6540,10C1,HBF,60Hz,1000Hz,6dB,fs/1,invert=0*/
		{ 0x10C2,	0x3F437BC0},		/*3F437BC0,10C2,HBF,60Hz,1000Hz,6dB,fs/1,invert=0*/
		{ 0x10C3,	0x3F7F7D40},		/*3F7F7D40,10C3,HBF,45Hz,60Hz,0dB,fs/1,invert=0*/
		{ 0x10C4,	0xBF7C6D00},		/*BF7C6D00,10C4,HBF,45Hz,60Hz,0dB,fs/1,invert=0*/
		{ 0x10C5,	0x3F7BEA40},		/*3F7BEA40,10C5,HBF,45Hz,60Hz,0dB,fs/1,invert=0*/
		...
		{ 0x10C9,	0x3BAED500},		/*3BAED500,10C9,LPF,1Hz,32dB,fs/1,invert=0*/
		{ 0x10CA,	0x3BAED500},		/*3BAED500,10CA,LPF,1Hz,32dB,fs/1,invert=0*/
		{ 0x10CB,	0x3F7FEE80},		/*3F7FEE80,10CB,LPF,1Hz,32dB,fs/1,invert=0*/
		{ 0x10CC,	0x3E0FC5C0},		/*3E0FC5C0,10CC,LBF,3.5Hz,25Hz,0dB,fs/1,invert=0*/
		{ 0x10CD,	0xBE0ED000},		/*BE0ED000,10CD,LBF,3.5Hz,25Hz,0dB,fs/1,invert=0*/
		{ 0x10CE,	0x3F7FC280},		/*3F7FC280,10CE,LBF,3.5Hz,25Hz,0dB,fs/1,invert=0*/
		...
		{ 0x10D7,	0x3F8EF7C0},		/*3F8EF7C0,10D7,LPF,500Hz,25dB,fs/1,invert=0*/
		{ 0x10D8,	0x3F8EF7C0},		/*3F8EF7C0,10D8,LPF,500Hz,25dB,fs/1,invert=0*/
		{ 0x10D9,	0x3F5FD780},		/*3F5FD780,10D9,LPF,500Hz,25dB,fs/1,invert=0*/
		{ 0x10DA,	0x3F7B0A00},		/*3F7B0A00,10DA,PKF,1300Hz,-3dB,5,fs/1,invert=0*/
		{ 0x10DB,	0xBFE0EDC0},		/*BFE0EDC0,10DB,PKF,1300Hz,-3dB,5,fs/1,invert=0*/
		{ 0x10DC,	0x3FE0EDC0},		/*3FE0EDC0,10DC,PKF,1300Hz,-3dB,5,fs/1,invert=0*/
		{ 0x10DD,	0x3F62FDC0},		/*3F62FDC0,10DD,PKF,1300Hz,-3dB,5,fs/1,invert=0*/
		{ 0x10DE,	0xBF5E07C0},		/*BF5E07C0,10DE,PKF,1300Hz,-3dB,5,fs/1,invert=0*/
		{ 0x10E0,	0x3F7C5880},		/*3F7C5880,10E0,PKF,650Hz,-3dB,4,fs/1,invert=0*/
		{ 0x10E1,	0xBFEFD200},		/*BFEFD200,10E1,PKF,650Hz,-3dB,4,fs/1,invert=0*/
		{ 0x10E2,	0x3FEFD200},		/*3FEFD200,10E2,PKF,650Hz,-3dB,4,fs/1,invert=0*/
		{ 0x10E3,	0x3F6AA180},		/*3F6AA180,10E3,PKF,650Hz,-3dB,4,fs/1,invert=0*/
		{ 0x10E4,	0xBF66FA40},		/*BF66FA40,10E4,PKF,650Hz,-3dB,4,fs/1,invert=0*/
		...
		{ 0x1104,	0x38A8A540},		/*38A8A540,1104,LPF,0.6Hz,0dB,fs/1,invert=0*/
		{ 0x1105,	0x38A8A540},		/*38A8A540,1105,LPF,0.6Hz,0dB,fs/1,invert=0*/
		{ 0x1106,	0x3F7FF580},		/*3F7FF580,1106,LPF,0.6Hz,0dB,fs/1,invert=0*/
		{ 0x1107,	0x3F800000},		/*3F800000,1107,0dB,invert=0*/
		{ 0x1108,	0xBF800000},		/*BF800000,1108,0dB,invert=1*/
		{ 0x1109,	0x00000000},		/*00000000,1109,Cutoff,invert=0*/
		...
		{ 0x1112,	0x3F7FFD00},		/*3F7FFD00,1112,Free,fs/1,invert=0*/
		{ 0x1113,	0x3FC83380},		/*3FC83380,1113,HBF,50Hz,150Hz,4dB,fs/1,invert=0*/
		{ 0x1114,	0xBFC58900},		/*BFC58900,1114,HBF,50Hz,150Hz,4dB,fs/1,invert=0*/
		{ 0x1115,	0x3F75E8C0},		/*3F75E8C0,1115,HBF,50Hz,150Hz,4dB,fs/1,invert=0*/
		{ 0x1116,	0x3F06BD80},		/*3F06BD80,1116,LBF,0.2Hz,0.38Hz,0dB,fs/1,invert=0*/
		{ 0x1117,	0xBF06BA00},		/*BF06BA00,1117,LBF,0.2Hz,0.38Hz,0dB,fs/1,invert=0*/
		{ 0x1118,	0x3F7FFC80},		/*3F7FFC80,1118,LBF,0.2Hz,0.38Hz,0dB,fs/1,invert=0*/
		...
		{ 0x111E,	0x00000000},		/*00000000,111E,Cutoff,invert=0*/
		...
		{ 0x1146,	0x38A8A540},		/*38A8A540,1146,LPF,0.6Hz,0dB,fs/1,invert=0*/
		{ 0x1147,	0x38A8A540},		/*38A8A540,1147,LPF,0.6Hz,0dB,fs/1,invert=0*/
		{ 0x1148,	0x3F7FF580},		/*3F7FF580,1148,LPF,0.6Hz,0dB,fs/1,invert=0*/
		...
		{ 0x11B0,	0x3E0DE280},		/*3E0DE280,11B0,LPF,1200Hz,0dB,fs/1,invert=0*/
		{ 0x11B1,	0x3E0DE280},		/*3E0DE280,11B1,LPF,1200Hz,0dB,fs/1,invert=0*/
		{ 0x11B2,	0x3F390EC0},		/*3F390EC0,11B2,LPF,1200Hz,0dB,fs/1,invert=0*/
		...
		{ 0x11C0,	0x3FE304C0},		/*3FE304C0,11C0,HBF,60Hz,1000Hz,6dB,fs/1,invert=0*/
		{ 0x11C1,	0xBFDF6540},		/*BFDF6540,11C1,HBF,60Hz,1000Hz,6dB,fs/1,invert=0*/
		{ 0x11C2,	0x3F437BC0},		/*3F437BC0,11C2,HBF,60Hz,1000Hz,6dB,fs/1,invert=0*/
		{ 0x11C3,	0x3F7F7D40},		/*3F7F7D40,11C3,HBF,45Hz,60Hz,0dB,fs/1,invert=0*/
		{ 0x11C4,	0xBF7C6D00},		/*BF7C6D00,11C4,HBF,45Hz,60Hz,0dB,fs/1,invert=0*/
		{ 0x11C5,	0x3F7BEA40},		/*3F7BEA40,11C5,HBF,45Hz,60Hz,0dB,fs/1,invert=0*/
		...
		{ 0x11C9,	0x3BAED500},		/*3BAED500,11C9,LPF,1Hz,32dB,fs/1,invert=0*/
		{ 0x11CA,	0x3BAED500},		/*3BAED500,11CA,LPF,1Hz,32dB,fs/1,invert=0*/
		{ 0x11CB,	0x3F7FEE80},		/*3F7FEE80,11CB,LPF,1Hz,32dB,fs/1,invert=0*/
		{ 0x11CC,	0x3E0FC5C0},		/*3E0FC5C0,11CC,LBF,3.5Hz,25Hz,0dB,fs/1,invert=0*/
		{ 0x11CD,	0xBE0ED000},		/*BE0ED000,11CD,LBF,3.5Hz,25Hz,0dB,fs/1,invert=0*/
		{ 0x11CE,	0x3F7FC280},		/*3F7FC280,11CE,LBF,3.5Hz,25Hz,0dB,fs/1,invert=0*/
		...
		{ 0x11D7,	0x3F8EF7C0},		/*3F8EF7C0,11D7,LPF,500Hz,25dB,fs/1,invert=0*/
		{ 0x11D8,	0x3F8EF7C0},		/*3F8EF7C0,11D8,LPF,500Hz,25dB,fs/1,invert=0*/
		{ 0x11D9,	0x3F5FD780},		/*3F5FD780,11D9,LPF,500Hz,25dB,fs/1,invert=0*/
		{ 0x11DA,	0x3F7B0A00},		/*3F7B0A00,11DA,PKF,1300Hz,-3dB,5,fs/1,invert=0*/
		{ 0x11DB,	0xBFE0EDC0},		/*BFE0EDC0,11DB,PKF,1300Hz,-3dB,5,fs/1,invert=0*/
		{ 0x11DC,	0x3FE0EDC0},		/*3FE0EDC0,11DC,PKF,1300Hz,-3dB,5,fs/1,invert=0*/
		{ 0x11DD,	0x3F62FDC0},		/*3F62FDC0,11DD,PKF,1300Hz,-3dB,5,fs/1,invert=0*/
		{ 0x11DE,	0xBF5E07C0},		/*BF5E07C0,11DE,PKF,1300Hz,-3dB,5,fs/1,invert=0*/
		{ 0x11E0,	0x3F7C5880},		/*3F7C5880,11E0,PKF,650Hz,-3dB,4,fs/1,invert=0*/
		{ 0x11E1,	0xBFEFD200},		/*BFEFD200,11E1,PKF,650Hz,-3dB,4,fs/1,invert=0*/
		{ 0x11E2,	0x3FEFD200},		/*3FEFD200,11E2,PKF,650Hz,-3dB,4,fs/1,invert=0*/
		{ 0x11E3,	0x3F6AA180},		/*3F6AA180,11E3,PKF,650Hz,-3dB,4,fs/1,invert=0*/
		{ 0x11E4,	0xBF66FA40},		/*BF66FA40,11E4,PKF,650Hz,-3dB,4,fs/1,invert=0*/
...
/* 8bit */
OISINI__ const struct STFILREG	CsFilReg_13M[]	= {
		{ 0x0111,	0x00},		/*00,0111*/
		{ 0x0113,	0x00},		/*00,0113*/
		{ 0x0114,	0x00},		/*00,0114*/
		{ 0x0172,	0x00},		/*00,0172*/
...
/* 32bit */
OISINI__ const struct STFILRAM	CsFilRam_13M[]	= {
		{ 0x1000,	0x3F800000},		/*3F800000,1000,0dB,invert=0*/
		{ 0x1001,	0x3F800000},		/*3F800000,1001,0dB,invert=0*/
		{ 0x1002,	0x00000000},		/*00000000,1002,Cutoff,invert=0*/
		{ 0x1003,	0x3F800000},		/*3F800000,1003,0dB,invert=0*/
		...
		{ 0x10B8,	0x3F800000},		/*3F800000,10B8,0dB,invert=0*/
		{ 0x10B9,	0x00000000},		/*00000000,10B9,Cutoff,invert=0*/
		{ 0x10C0,	0x3F944EC0},		/*3F944EC0,10C0,HBF,50Hz,700Hz,2dB,fs/1,invert=0*/
		{ 0x10C1,	0xBF925540},		/*BF925540,10C1,HBF,50Hz,700Hz,2dB,fs/1,invert=0*/
		{ 0x10C2,	0x3F5414C0},		/*3F5414C0,10C2,HBF,50Hz,700Hz,2dB,fs/1,invert=0*/
		...
		{ 0x10DA,	0x3F649140},		/*3F649140,10DA,PKF,1000Hz,-11dB,3,fs/1,invert=0*/
		{ 0x10DB,	0xBFD21D40},		/*BFD21D40,10DB,PKF,1000Hz,-11dB,3,fs/1,invert=0*/
		{ 0x10DC,	0x3FD21D40},		/*3FD21D40,10DC,PKF,1000Hz,-11dB,3,fs/1,invert=0*/
		{ 0x10DD,	0x3F4F0940},		/*3F4F0940,10DD,PKF,1000Hz,-11dB,3,fs/1,invert=0*/
		{ 0x10DE,	0xBF339A80},		/*BF339A80,10DE,PKF,1000Hz,-11dB,3,fs/1,invert=0*/
		...
		{ 0x11B8,	0x3F800000},		/*3F800000,11B8,0dB,invert=0*/
		{ 0x11B9,	0x00000000},		/*00000000,11B9,Cutoff,invert=0*/
		{ 0x11C0,	0x3F944EC0},		/*3F944EC0,11C0,HBF,50Hz,700Hz,2dB,fs/1,invert=0*/
		{ 0x11C1,	0xBF925540},		/*BF925540,11C1,HBF,50Hz,700Hz,2dB,fs/1,invert=0*/
		{ 0x11C2,	0x3F5414C0},		/*3F5414C0,11C2,HBF,50Hz,700Hz,2dB,fs/1,invert=0*/
		...
		{ 0x11DA,	0x3F649140},		/*3F649140,11DA,PKF,1000Hz,-11dB,3,fs/1,invert=0*/
		{ 0x11DB,	0xBFD21D40},		/*BFD21D40,11DB,PKF,1000Hz,-11dB,3,fs/1,invert=0*/
		{ 0x11DC,	0x3FD21D40},		/*3FD21D40,11DC,PKF,1000Hz,-11dB,3,fs/1,invert=0*/
		{ 0x11DD,	0x3F4F0940},		/*3F4F0940,11DD,PKF,1000Hz,-11dB,3,fs/1,invert=0*/
		{ 0x11DE,	0xBF339A80},		/*BF339A80,11DE,PKF,1000Hz,-11dB,3,fs/1,invert=0*/
