...
static const struct chip_struct chip_data[] = {
	...
	{FPC1020_CHIP_1021F, 0x021f, 1, FPC1021_ROWS, FPC1021_COLUMNS, FPC102X_ADC_GROUP_SIZE, 8000, 1000},
...
int fpc1020_reset(fpc1020_data_t *fpc1020)
{
	...
	printk(KERN_INFO "fpc1020_check_irq_after_reset start\n");

	error = fpc1020_check_irq_after_reset(fpc1020);

	printk(KERN_INFO "fpc1020_check_irq_after_reset end\n");
