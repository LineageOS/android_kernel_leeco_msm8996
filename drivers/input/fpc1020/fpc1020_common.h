...
#define FPC_FACTORY_MODE_SET  _IOW('K', 6, int)
#define FPC_FACTORY_MODE_CLR  _IOW('K', 7, int)
#define FPC_FACTORY_MODE_GET  _IOR('K', 8, int)
#define FPC_SPI_CLK_SET              _IOR('K', 9, int)
#define FPC_SPI_CLK_CLR              _IOR('K', 10, int)
